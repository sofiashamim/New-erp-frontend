...
const Accountant = () => {
  ...
  const apiEndpoint = 'http://localhost:8080/user/account/getAllAcc';
  ...
  const onEdit = async (id) => {
    try {
      let response = await fetch(`http://localhost:8080/user/account/update/${id}`, {
        method: 'PUT',
  ...
  const onDelete = async (id) => {
    try {
      let response = await fetch(`http://localhost:8080/user/account/delete/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
