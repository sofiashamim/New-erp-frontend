...
const Merchandiser = () => {
    ...
    const apiEndpoint = 'http://localhost:8080/user/merch/getAllMerch';
    ...
    const onEdit = async (id) => {
      try {
        let response = await fetch(`http://localhost:8080/user/merch/update/${id}`, {
          method: 'PUT',
    ...
    const onDelete = async (id) => {
      try {
        let response = await fetch(`http://localhost:8080/user/merch/delete/${id}`, {
          method: 'DELETE',
        });
        if (response.ok) {
