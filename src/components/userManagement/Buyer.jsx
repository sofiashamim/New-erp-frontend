...
const Buyer = () => {
  ...
  const apiEndpoint = 'http://localhost:8080/user/buy/getAllBuyer';
  ...
  const onEdit = async (id) => {
    try {
      let response = await fetch(`http://localhost:8080/user/buy/update/${id}`, {
        method: 'PUT',
  ...
  const onDelete = async (id) => {
    try {
      let response = await fetch(`http://localhost:8080/user/buy/delete/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
