...
const Employees = () => {
    ...
    const apiEndpoint = 'http://localhost:8080/hrm/emp/getAllEmp';
  ...
  const onEdit = async (id) => {
    try {
      let response = await fetch(`http://localhost:8080/hrm/emp/update/${id}`, {
        method: 'PUT',
  ...
  const onDelete = async (id) => {
    try {
      console.log(id)
      let response = await fetch(`http://localhost:8080/hrm/emp/delete/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
